...
import aproject.pages.GoogleSearchResultsPage;
import aproject.pages.SamplePageFactory;
...
public class SampleSuiteITest extends AbstractSuite<SamplePageFactory> {
  ...
  public void we_should_be_able_to_pass_desired_urls_to_pages() {
    getPageFactory()
      .getHomePage("/intl/en/policies/privacy/?fg=aproject")
    ;
  }
